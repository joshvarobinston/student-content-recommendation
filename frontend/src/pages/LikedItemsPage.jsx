// pages/LikedItemsPage.jsx
import { useState, useEffect } from 'react'
import { toast } from 'react-toastify'
import { getLikedItems } from '../api/accountApi'
  ...
  return (
    <MainLayout>
      <div className="max-w-6xl mx-auto">
        ...
        {/* Header */}
        <div className="mb-6">
          <h1 className="font-heading font-bold text-2xl text-slate-800">❤️ Liked Items</h1>
          <p className="text-slate-400 text-sm mt-1">
            {!loading && `${items.length} liked item${items.length !== 1 ? 's' : ''}`}
          </p>
        </div>
        ...
        {loading ? (
          ...
          <EmptyState
            ...
            message="Like content from your feed by clicking the heart icon."
          />
        ) : (
          <div className={
